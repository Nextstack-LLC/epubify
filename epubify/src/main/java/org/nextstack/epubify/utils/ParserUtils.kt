...
import org.nextstack.epubify.model.JsoupOutput
...
import org.nextstack.epubify.parser.EpubWhitelist
...
internal fun File.parseDocument(
    ...
    parsedImages: List<org.nextstack.epubify.model.Image>
) : JsoupOutput {
...
private fun handleImageNode(
    image: org.nextstack.epubify.model.Image
) : Node {
